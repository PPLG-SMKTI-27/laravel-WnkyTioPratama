...
<nav class="bg-indigo-600/70 backdrop-blur p-4 flex justify-between items-center border-b border-white/10 sticky top-0 z-50">
    <a href="{{ route('app.home') }}" class="font-bold text-white">Winky Creative</a>

    <ul class="flex gap-6 items-center">
        <li><a href="{{ route('app.home') }}" class="hover:text-indigo-200">Home</a></li>
        <li><a href="{{ route('about') }}" class="hover:text-indigo-200">About</a></li>
        <li><a href="{{ route('blog') }}" class="hover:text-indigo-200">Blog</a></li>
        <li><a href="{{ route('project') }}" class="hover:text-indigo-200">Project</a></li>
        ...
        @auth
            ...
            <!-- <li>
                <a href="{{ route('profile.edit') }}" class="hover:text-indigo-200">Profile</a>
            </li> -->
